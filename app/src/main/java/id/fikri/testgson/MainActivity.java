    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new ApiConnect().execute("https://private-7bb04d-signandlogin.apiary-mock.com/users/1");
            }
        });
    }
    ...
    public void process_json(String json_str) throws JSONException {
        try {
            ...
            for (int i = 0; i < users.length(); i++) {
                ...
                Log.e("", "id : "+model_user.getId());
                lbl_http_connection.append(
                        "Id = " + model_user.getId() + System.getProperty("line.separator") +
                                "Email = " + model_user.getEmail() + System.getProperty("line.separator") +
                                "Password = " + model_user.getPassword() + System.getProperty("line.separator")
                );
            }
